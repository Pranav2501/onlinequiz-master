...
def index(request):
    ...
    #read row by row
    # col1=q, col2=a1, ..
    #temp_quiz = Quiz.create(question=col1, option1=col2,..)
    # temp_quiz.save()
...
def aboutus_view(request):
    if "GET" == request.method:
        ...
        for i in excel_data:
            ...
            if i[6] == i[2]:
                q=Question.objects.create(marks=i[0],question=i[1],option1=i[2],option2=i[3],option3=i[4],option4=i[5],answer='Option1',mp3file="question"+str(k)+".mp3",is_passage=x,is_longpassage=y,is_email=z)    
            ...
            if i[6] == i[5]:
                q=Question.objects.create(marks=i[0],question=i[1],option1=i[2],option2=i[3],option3=i[4],option4=i[5],answer='Option4',mp3file="question"+str(k)+".mp3",is_passage=x,is_longpassage=y,is_email=z)
        ...
        return render(request, 'quiz/aboutus.html', {"excel_data":excel_data})
